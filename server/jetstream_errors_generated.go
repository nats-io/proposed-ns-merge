...
const (
	...
	JSConsumerAlreadyExists ErrorIdentifier = 10143
	...
	JSConsumerDoesNotExist ErrorIdentifier = 10144
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerAlreadyExists:                    {Code: 400, ErrCode: 10143, Description: "consumer already exists"},
		...
		JSConsumerDoesNotExist:                     {Code: 400, ErrCode: 10144, Description: "consumer does not exist"},
